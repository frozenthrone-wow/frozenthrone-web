    ...
    <div class="relative w-full h-full max-w-2xl md:h-auto">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-6 space-y-6">
                <ul class="w-full divide-y divide-gray-200 dark:divide-gray-700 text-white" id ="downloads-holder">
                Go to <pre>Client Folder\Data\enUS\realmlist.wtf</pre>
                <code>SET realmList "188.212.101.142"</code>
                </ul>
            </div>
            <!-- Modal footer -->
